...
Page({
  ...
  data: {
    ...
    praporList: ["首秀", "考验", "硝烟野餐", "往事速递", "罪证", "冰淇淋蛋筒", "邮递特派员 Part.1",
      "探囊取物", "Polikhim流浪汉", "大客户", "石油存储", "惩罚者 Part.1", "惩罚者 Part.2", "惩罚者 Part.3",
      "惩罚者 Part.4", "惩罚者 Part.5", "惩罚者 Part.6", "彻夜难眠", "试驾 Part.1", "掷弹兵", "左右逢源", "材料控制"],
    theraistList: ["邮递特派员 Part.2", "短缺", "卫生标准 Part.1", "卫生标准 Part.2", "水瓶座行动 Part.1", "卫生标准 Part.2",
      "止痛药", "药剂师", "供给计划", "一般储备", "汽车修理", "出于好奇", "重获信任", "医疗隐私 Part.1", "医疗隐私 Part.2",
      "医疗隐私 Part.3", "医疗隐私 Part.4", "医疗隐私 Part.5", "私人诊所", "运动员", "灭虫服务", "一天一个苹果-医生远离我"],
    fenceList: ["收藏家"],
    skierList: ["暗中破坏", "供应商", "敲诈者", "风波", "U盘里有什么", "金色失物", "化学品 Part.1", "化学品 Part.2", "化学品 Part.3",
      "化学品 Part.4", "西方来客 Part.1", "西方来客 Part.2", "维他命 Part.1", "维他命 Part.2", "情报就是力量", "租借法案",
      "愿者上钩", "一派胡言", "大音希声", "坚如燧石", "借刀杀人"],
    peacekeeperList: ["渔具", "猎虎行动", "破铜烂铁", "鹰眼", "人道主义援助", "海边假期 Part.1", "海边假期 Part.2", "海边假期 Part.3",
      "海边假期 Part.4", "海边假期 Part.5", "海边假期 Part.6", "海边假期 Part.7", "邪教 Part.1", "邪教 Part.2", "神秘货物 Part.1",
      "神秘货物 Part.2", "神秘货物 Part.3", "神秘货物 Part.4", "湿活 Part.1", "湿活 Part.2", "湿活 Part.3", "湿活 Part.4", "湿活 Part.5",
      "湿活 Part.6", "租借法案 Part.2", "维和任务", "向导", "导师"],
